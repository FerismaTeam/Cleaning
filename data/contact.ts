// this file contains data related to contact that you amy want to change all over the site.
...
export { telephone, address, mobile, official_mail, service_area, opening_hours, instagramHandle, website_url, operational_region }