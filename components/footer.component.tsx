            ...
            <Box>
                ...
                >
                    ...
                    <VStack align={"start"} gap={6}>
                        ...
                        <Button asChild variant={"outline"} w={8} colorPalette={"white"} _hover={{ color: "blue.800" }} _active={{ color: "blue.800" }} color={"bg"} rounded={"full"}>
                    ...
                    <VStack align={"start"} gap={3}>
                        ...
                        <Link href={"/"} className="flex gap-2 items-center hover:opacity-70 active:opacity-70">
                            <FaHome />
                            Home
                        </Link>

                        <Link href={"/#services"} className="flex gap-2 items-center hover:opacity-70 active:opacity-70">
                            <FaSuitcase />
                            Leistungen
                        </Link>

                        <Link href={"/ueber-uns"} className="flex gap-2 items-center hover:opacity-70 active:opacity-70">
                            <FaInfoCircle />
                            Über uns
                        </Link>

                        <Link href={"/#references"} className="flex gap-2 items-center hover:opacity-70 active:opacity-70">
                            <FaStar />
                            Referenzen
                        </Link>

                        <Link href={"/#contact"} className="flex gap-2 items-center hover:opacity-70 active:opacity-70">
                            <FaEnvelope />
                            Kontakt
                        </Link>
                    ...
                    <VStack align={"start"} gap={3}>
...

                        {
                            services.map((item, i) => {
                                return (
                                    <Link key={i} href={`/${item.link?.toLocaleLowerCase()}`} className="flex gap-2 items-center hover:opacity-70 active:opacity-70">
                                        <item.icon />
                                        {item.name}
                                    </Link>
                                )
                    ...
                    <VStack align={"start"} gap={5}>
                        ...
                        <Flex gap={3} alignItems={"start"}>
                            ...
                            <Box mt={-2}>
                                ...
                                <Text asChild opacity={0.85} fontWeight={"medium"}>
                                    <Link href={`tel:${telephone.replaceAll(" ", "")}`} className="hover:opacity-100! hover:text-blue-300! active:opacity-100! active:text-blue-300">
                                        {telephone}
                                    </Link>
                                </Text>
                            </Box>
                        ...
                        <Flex gap={3} alignItems={"start"}>
                            ...
                            <Box mt={-2}>
                                ...
                                <Text asChild opacity={0.85} fontWeight={"medium"} >
                                    <Link href={`tel:${mobile.replaceAll(" ", "")}`} className="hover:opacity-100! hover:text-blue-300! active:opacity-100! active:text-blue-300">
                                        {mobile}
                                    </Link>
                                </Text>
                            </Box>
                        ...
                        <Flex gap={3} alignItems={"start"}>
                            ...
                            <Box mt={-2}>
                                ...
                                <Text asChild opacity={0.85} fontWeight={"medium"} >
                                    <Link href={`mailto:${official_mail}`} className="hover:opacity-100! hover:text-blue-300! active:opacity-100! active:text-blue-300">
                                    {official_mail}
                                    </Link>
                                </Text>
                            </Box>
                        ...
                        <Button asChild colorPalette={"blue"} _hover={{ bg: "blue.700" }} _active={{ bg: "blue.700" }} shadow={"xl"} mt={2} ml={2}>
                            <Link href={"/#contact"}>
                ...
                <HStack gap={5} flexWrap={"wrap"} justifyContent={"space-between"} fontSize={"sm"}>
                    ...
                    <HStack gap={2}>
                        ...
                        <Link href={"/rechtliches#imprint"} className="hover:opacity-80 active:opacity-80">
                        Impressum
                        </Link>

                        <Link href={"/rechtliches#privacy"} className="hover:opacity-80 active:opacity-80">
                        Datenschutz
                        </Link>

                        <Link href={"/rechtliches#tnc"} className="hover:opacity-80 active:opacity-80">
                        AGB
                        </Link>
