            ...
            <Box>
                ...
                >
                    ...
                    <VStack align={"start"} gap={6}>
                        ...
                        <Button asChild variant={"outline"} w={8} colorPalette={"white"} _hover={{ color: "blue.800" }} _focus={{ color: "blue.800" }}   tabIndex={0} color={"bg"} rounded={"full"}>
                    ...
                    <VStack align={"start"} gap={3}>
                        ...
                        <Link href={"/"} className="flex gap-2 items-center hover:opacity-70 focus:opacity-70   " tabIndex={0}>
                            <FaHome />
                            Home
                        </Link>

                        <Link href={"/#services"} className="flex gap-2 items-center hover:opacity-70 focus:opacity-70   " tabIndex={0}>
                            <FaSuitcase />
                            Leistungen
                        </Link>

                        <Link href={"/ueber-uns"} className="flex gap-2 items-center hover:opacity-70 focus:opacity-70   " tabIndex={0}>
                            <FaInfoCircle />
                            Über uns
                        </Link>

                        <Link href={"/#references"} className="flex gap-2 items-center hover:opacity-70 focus:opacity-70   " tabIndex={0}>
                            <FaStar />
                            Referenzen
                        </Link>

                        <Link href={"/#contact"} className="flex gap-2 items-center hover:opacity-70 focus:opacity-70   " tabIndex={0}>
                            <FaEnvelope />
                            Kontakt
                        </Link>
                    ...
                    <VStack align={"start"} gap={3}>
...

                        {
                            services.map((item, i) => {
                                return (
                                    <Link key={i} href={`/${item.link?.toLocaleLowerCase()}`} className="flex gap-2 items-center hover:opacity-70 focus:opacity-70   " tabIndex={0}>
                                        <item.icon />
                                        {item.name}
                                    </Link>
                                )
                    ...
                    <VStack align={"start"} gap={5}>
                        ...
                        <Flex gap={3} alignItems={"start"}>
                            ...
                            <Box mt={-2}>
                                ...
                                <Text asChild opacity={0.85} fontWeight={"medium"}>
                                    <Link href={`tel:${telephone.replaceAll(" ", "")}`} className="hover:opacity-100! hover:text-blue-300! focus:opacity-100! focus:text-blue-300      " tabIndex={0}>
                                        {telephone}
                                    </Link>
                                </Text>
                            </Box>
                        ...
                        <Flex gap={3} alignItems={"start"}>
                            ...
                            <Box mt={-2}>
                                ...
                                <Text asChild opacity={0.85} fontWeight={"medium"} >
                                    <Link href={`tel:${mobile.replaceAll(" ", "")}`} className="hover:opacity-100! hover:text-blue-300! focus:opacity-100! focus:text-blue-300      " tabIndex={0}>
                                        {mobile}
                                    </Link>
                                </Text>
                            </Box>
                        ...
                        <Flex gap={3} alignItems={"start"}>
                            ...
                            <Box mt={-2}>
                                ...
                                <Text asChild opacity={0.85} fontWeight={"medium"} >
                                    <Link href={`mailto:${official_mail}`} className="hover:opacity-100! hover:text-blue-300! focus:opacity-100! focus:text-blue-300      " tabIndex={0}>
                                    {official_mail}
                                    </Link>
                                </Text>
                            </Box>
                        ...
                        <Button asChild colorPalette={"blue"} _hover={{ bg: "blue.700" }} _focus={{ bg: "blue.700" }}   tabIndex={0} shadow={"xl"} mt={2} ml={2}>
                            <Link href={"/#contact"}>
                ...
                <HStack gap={5} flexWrap={"wrap"} justifyContent={"space-between"} fontSize={"sm"}>
                    ...
                    <HStack gap={2}>
                        ...
                        <Link href={"/rechtliches#imprint"} className="hover:opacity-80 focus:opacity-80   " tabIndex={0}>
                        Impressum
                        </Link>

                        <Link href={"/rechtliches#privacy"} className="hover:opacity-80 focus:opacity-80   " tabIndex={0}>
                        Datenschutz
                        </Link>

                        <Link href={"/rechtliches#tnc"} className="hover:opacity-80 focus:opacity-80   " tabIndex={0}>
                        AGB
                        </Link>
