                ...
                <VStack w="full">
...

                        {
                            specialCleaningServicesInDetail.map((service, i) => {
                                ...
                                return <GridItem asChild key={i}>
                                    <Box className="group">
                                        <VStack w={"full"} h={"full"} className="group-hover:-translate-y-[10px]! group-focus:-translate-y-[10px]! duration-150 group-hover:shadow-lg group-focus:shadow-lg" rounded={"lg"} bg={ isFirst || isLast ? "blue.100/30" : "bg"} border={"1px solid"} align={"start"} borderColor={"blue.500/10"} borderTop={"6px solid"} borderTopColor={"blue.500"} p={{ base: 2, md: 6 }}>
                    ...
                    <VStack gap={6} w={"full"} color={"bg"} rounded={"xl"} className="gradient_light_background_one" py={{ base: 6, md: 12 }} px={{ base: 4, md: 6 }}>
                        ...
                        <HStack gap={4} justify={"center"} gapY={3} mt={5} flexWrap={"wrap"}>
                            ...
                            <Button asChild  bg={"yellow.500"} gap={3} p={{ base: 8, md: 3 }} _hover={{ bg: "yellow.400" }} _focus={{ bg: "yellow.400" }} color={"bg.inverted"} rounded={"lg"}>
                                <Link href={"#contact"}>
                            ...
                            <Button asChild bg={"bg"} color={"bg.inverted"} _hover={{ bg: "bg/85" }} _focus={{ bg: "bg/85" }} rounded={"lg"}>
                                <Link href={`tel:${telephone.replaceAll(" ", "")}`}>
                                    <Text scale={0.75}><FaPhoneAlt /></Text>
                                      {telephone}
                                </Link>
                ...
                <Box w={"full"} pos={"relative"} zIndex={1}>
                    <VStack textAlign={"center"} gap={10} w="100%">
                        ...
                        >
                            ...
                            <GridItem colSpan={{ base: "auto", md: 2, lg: "auto" }}  textAlign={"left"} _hover={{ bg: "bg/25" }} _focus={{ bg: "bg/25" }} w={"full"} h={"full"} bg={"bg/15"} border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={5}>
                                <VStack gap={4} align={"start"}>
                                    <Center w={10} rounded={"md"} aspectRatio={"square"} color={"bg"} shadow={"lg"} bg={"blue.800"}>
                                        <FaTools />
                                    </Center>
                        ...
                        <VStack textAlign={"center"} _hover={{ bg: "bg/8" }} _focus={{ bg: "bg/8" }} w={"full"} h={"full"} bg={"bg/5"} border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={5}>
                        ...
                        >
                            ...
                            <GridItem asChild>
                                <VStack _hover={{ bg: "bg/15" }} _focus={{ bg: "bg/15" }} w={"full"} h={"full"} bg={"bg/5"} border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={5} gap={4}>
                                    <HStack gap={3} w={"full"}>
                            ...
                            <GridItem asChild>
                                <VStack _hover={{ bg: "bg/15" }} _focus={{ bg: "bg/15" }} w={"full"} h={"full"} bg={"bg/5"} border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={5}>
                                    <HStack gap={3} w={"full"}>
                        ...
                        <VStack textAlign={"center"} w={"full"} h={"full"} className="gradient_light_background_one" border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={{ base: 2.5, md: 5 }}>
                            ...
                            <Grid templateColumns={{ base: "1fr", xl: "repeat(3, 1fr)" }} w={"full"} mt={9} gap={5}>
                                ...
                                <HStack asChild gap={3} align={"start"} bg={"bg/5"} rounded={"md"} p={4} _hover={{ bg: "bg/10" }} _focus={{ bg: "bg/10" }}>
                        ...
                        <VStack gap={3} w={"full"} color={"bg"} rounded={"xl"} _hover={{ bg: "bg/7.5" }} _focus={{ bg: "bg/7.5" }} py={6} bg={"bg/5"} border={"1px solid"} borderColor={"bg/40"} shadow={"xl"} px={6}>
