...
MEDIZINISCHE REINIGUNG  Nürnberg, Fürth & Umgebung</Badge>
                    ...
                    <HStack gap={6} justify={"center"} gapY={6} mt={12} flexWrap={"wrap"}>
                        ...
                        <Button asChild colorPalette={"blue"} _hover={{ bg: "blue.700" }} _focus={{ bg: "blue.700" }} textWrap={"wrap"} py={6} px={5} rounded={"lg"} fontSize={"16px"}>
                            <Link href={"#contact"}>
                        ...
                        <Button asChild bg={"bg/15"} py={6} px={5} _hover={{ bg: "bg/25" }} _focus={{ bg: "bg/25" }} border={"1px solid"} borderColor={"bg/40"} rounded={"lg"} fontSize={"16px"}>
            ...
            <Box as={"section"} bg={"blue.100/20"}>
                ...
                <VStack w="full">
                    ...
                    <Grid templateColumns={{ base: "1fr", md: "repeat(2, 1fr)", lg: "repeat(4, 1fr)" }} w={"full"} gap={5} mb={12}>
                        ...
                        <VStack gap={2} bg={"bg"} border={"1px solid"} borderColor={"bg.inverted/10"} rounded={"xl"} _hover={{ borderColor: "blue.500/80", shadow: "xl" }} _focus={{ borderColor: "blue.500/80", shadow: "xl" }} p={3} py={6} textAlign={"center"}>
                        ...
                        <VStack minW={"200px"} gap={2} bg={"bg"} border={"1px solid"} borderColor={"bg.inverted/10"} rounded={"xl"} _hover={{ borderColor: "blue.500/80", shadow: "xl" }} _focus={{ borderColor: "blue.500/80", shadow: "xl" }} p={3} py={6}>
                            <Center w={12} aspectRatio={"square"} rounded={"full"} bg={"none"} color={"blue.400"} fontSize={"3xl"}>
                                <FaUserDoctor />
                            </Center>
                    ...
                    >
                        ...
                        <GridItem>
                            <VStack align={"start"} gap={5}>
                                ...
                                <HStack align={"start"} gap={5} p={5} rounded={"md"} bg={"bg"} border={"1px solid"} borderColor={"bg.inverted/20"} w={"full"} _hover={{ borderColor: "blue.700/50" }} _focus={{ borderColor: "blue.700/50" }}>
                    ...
                    <VStack mt={8} gap={6} w={"full"} color={"bg"} rounded={"xl"} className="gradient_light_background_one" py={12} px={6}>
                        ...
                        <HStack gap={4} justify={"center"} gapY={3} mt={5} flexWrap={"wrap"}>
                            ...
                            <Button asChild bg={"bg"} color={"bg.inverted"}  _hover={{ bg: "blue.100" }} _focus={{ bg: "blue.100" }} rounded={"lg"}>
                                <Link href={"#contact"}>
                ...
                <VStack w="full">
                    ...
                    <VStack gap={6} w={"full"} color={"bg"} rounded={"xl"} className="gradient_dark_background" py={12} px={6}>
                        ...
                        <HStack gap={4} justify={"center"} gapY={3} mt={5} flexWrap={"wrap"}>
                            ...
                            <Button asChild bg={"bg/15"} colorPalette={"blue"} _hover={{ bg: "bg/25" }} _focus={{ bg: "bg/25" }} rounded={"lg"}>
                                <Link href={`tel:${telephone.replaceAll(" ", "")}`}>
                                    <Text scale={0.75}><FaPhoneAlt /></Text>
                                     Sofort anrufen
                                </Link>
                ...
                <VStack w="full">
                            ...
                            otherServicesList.map((service, i) => {
                                ...
                                return <GridItem asChild key={i}>
                                       ...
                                       <Link href={service.link} className="group relative">
                                            <VStack className=" group-hover:-translate-y-2! group-hover:shadow-xl! group-focus:-translate-y-2! group-focus:shadow-xl! duration-150" bg={ isLast ? "blue.400/10" : "bg"} rounded={"lg"} border={"1px solid"} 
                                            borderWidth={isLast ? "2px" : "1px" } borderColor={isLast ? "blue.600" : "blue.500/30"} gap={4} align={"start"} _hover={{ bg: "blue.700", color: "bg" }} _focus={{ bg: "blue.700", color: "bg" }} h="full" p={7}>
                                                ...
                                                <Center w={10} aspectRatio={"square"} rounded={"md"} bg={"blue.700"} color={"bg"} fontSize={"xl"} className="duration-150 group-hover:text-3xl! group-focus:text-3xl!">
                                                    <service.icon />
                                                </Center>
                                                ...
                                                <Text _hover={{ textDecor: "underline" }} _focus={{ textDecor: "underline" }} fontSize={"sm"} fontWeight={"bold"} color={"blue.600"} display={"flex"} gap={2} className="group-hover:text-white! group-focus:text-white!" alignItems={"start"}>
                                                    
                                                    {service.redirect_label}
                                                    <Text as={"span"} mt={1} className="duration-150 group-hover:ml-1! group-focus:ml-1!"><FaArrowRight /></Text>
                    ...
                    <VStack gap={6} w={"full"} color={"bg"} rounded={"xl"} className="gradient_mix_four" py={12} px={6}>
                        ...
                        <HStack gap={4} justify={"center"} gapY={3} mt={5} flexWrap={"wrap"}>
                            ...
                            <Button asChild colorPalette={"yellow"} rounded={"lg"} _hover={{ bg: "yellow.500" }} _focus={{ bg: "yellow.500" }}>
                                <Link href={"#contact"}>
                                    <Text scale={0.75}><FaCalendarCheck /></Text>
                                          Kostenlose Hygienebesichtigung
                                </Link>
                ...
                <VStack w="full">
                    ...
                    <Box w={{ base: "full", xl: "60%" }} p={{ base: 0, md: 8 }} md={{ bg: "bg/5", border: "1px solid", shadow: "2xl" }} borderColor={"bg/20"} color={"bg"} pos={"relative"} rounded={"xl"}>
                        ...
                        <form ref={formRef} onSubmit={handleContact}>
                            ...
                            <Button type="submit" color={"blue.800"} _hover={{ bg: "blue.200" }} _focus={{ bg: "blue.200" }} fontSize={"16px"} fontWeight={"bolder"} textWrap={"wrap"} bg={"blue.100"} py={{ base: 8, md: 6 }} w="full" rounded={"lg"}>
                    ...
                    <VStack gap={6} w={{ base: "full", xl: "40%" }} color={"bg"} pos={"relative"}>
                        ...
                        >
                            ...
                            <HStack w={"full"} gap={4}>
                                ...
                                <VStack align={"start"}>
                                    ...
                                    <Link className="-mt-1.5! font-bold! hover:underline! focus:underline!" href={`tel:${telephone.replaceAll(" ", "")}`}>{telephone}</Link>
                                </VStack>
                            </HStack>
                            ...
                            <HStack w={"full"} gap={4}>
                                ...
                                <VStack align={"start"}>
                                    ...
                                    <Link className="-mt-1.5! font-bold! hover:underline! focus:underline!" href={`tel:${mobile.replaceAll(" ", "")}`}>{mobile}</Link>
                                </VStack>
                            </HStack>
                            ...
                            <HStack w={"full"} gap={4}>
                                ...
                                <VStack align={"start"}>
                                    ...
                                    <Link className="-mt-1.5! font-bold! hover:underline! focus:underline!" href={`mailto:${official_mail}`}>{official_mail}</Link>
                                </VStack>
                            </HStack>
                        ...
                        <VStack align={"start"} rounded={"xl"} p={5} color={"bg"} bg={"red.600/90"} w={"100%"} shadow={"2xl"} gap={4}>
                            ...
                            <Button asChild bg={"bg"} color={"red.600"} _hover={{ bg: "red.800", color: "bg" }} _focus={{ bg: "red.800", color: "bg" }} rounded={"lg"}>
                                <Link href={`tel:${telephone.replaceAll(" ", "")}`}>
                                    <Text scale={0.75}><FaPhoneAlt /></Text>
                                     Notfall-Hotline
                                </Link>
