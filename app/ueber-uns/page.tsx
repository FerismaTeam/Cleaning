                    ...
                    <Flex gap={10} gapY={20} mt={14} flexDir={{ base: "column-reverse", xl: "row" }}>
                        ...
                        <Box w={{ base: "full", xl: "50%" }}>
                            ...
                            >
                                ...
                                <Box bg={"blue.100"} _hover={{ bg: "blue.900", color: "bg" }} _focus={{ bg: "blue.900", color: "bg" }} tabIndex={0}   className="duration-500 group" p={5} px={6} rounded={"lg"}>

                                    <VStack align={"start"} gap={2}>
                                        <Center w={14} h={14} rounded={"full"} bg={"blue.900"} color={"bg"} fontSize={"3xl"} tabIndex={0} className="group-hover:bg-white! group-hover:text-blue-900! group-focus:bg-white! group-focus:text-blue-900! group-   group-   duration-500"><FaHandshake /></Center>
                                ...
                                <Box bg={"blue.100"} _hover={{ bg: "blue.900", color: "bg" }} _focus={{ bg: "blue.900", color: "bg" }} tabIndex={0}   className="duration-500 group" p={5} px={6} rounded={"lg"}>
                                    ...
                                    <VStack align={"start"} gap={2}>
                                        <Center w={14} h={14} rounded={"full"} bg={"blue.900"} color={"bg"} fontSize={"3xl"} tabIndex={0} className="group-hover:bg-white! group-hover:text-blue-900! group-focus:bg-white! group-focus:text-blue-900! group-   group-   duration-500"><FaStar /></Center>
                                ...
                                <Box bg={"blue.100"} _hover={{ bg: "blue.900", color: "bg" }} _focus={{ bg: "blue.900", color: "bg" }} tabIndex={0}   className="duration-500 group" p={5} px={6} rounded={"lg"}>
                                    ...
                                    <VStack align={"start"} gap={2}>
                                        <Center w={14} h={14} rounded={"full"} bg={"blue.900"} color={"bg"} fontSize={"3xl"} tabIndex={0} className="group-hover:bg-white! group-hover:text-blue-900! group-focus:bg-white! group-focus:text-blue-900! group-   group-   duration-500"><FaHeart /></Center>
                                ...
                                <Box bg={"blue.100"} _hover={{ bg: "blue.900", color: "bg" }} _focus={{ bg: "blue.900", color: "bg" }} tabIndex={0}   className="duration-500 group" p={5} px={6} rounded={"lg"}>
                                    ...
                                    <VStack align={"start"} gap={2}>
                                        <Center w={14} h={14} rounded={"full"} bg={"blue.900"} color={"bg"} fontSize={"3xl"} tabIndex={0} className="group-hover:bg-white! group-hover:text-blue-900! group-focus:bg-white! group-focus:text-blue-900! group-   group-   duration-500"><FaEye /></Center>
            ...
            <Box as={"section"} bg={"blue.100"}>
                <Box py={5}>
                    ...
                    >
                        ...
                        <Box className="group">
                            <Box bg={"bg"} p={8} w={"full"} h={"full"} rounded={"lg"} shadow={"md"} _hover={{ shadow: "xl" }} tabIndex={0} _focus={{ shadow: "xl" }}    className="  group-hover:-translate-y-4 group-focus:-translate-y-4 group-   duration-500">
            ...
            <Box as="section" py={28}>
                ...
                <Box maxW={"900px !important"}>
                    ...
                    >
                        ...
                        <GridItem>
                            <Flex  asChild _hover={{ bg: "blue.700", color: "bg" }} _focus={{ bg: "blue.700", color: "bg" }} tabIndex={0}   className="duration-150 group" gap={4} alignItems={"center"} p={6} bg={"bg"} rounded={"lg"} shadow={"3px 3px 0 0 var(--chakra-colors-blue-600), -3px -3px 0 0 var(--chakra-colors-blue-400)"} px={8} h={"full"}>

                                <Link href={`tel:${telephone.replaceAll(" ", "")}`}>

                                <Center w={14} fontSize={"2xl"} aspectRatio={"square"} bg={"blue.700"} rounded={"full"} tabIndex={0} color={"bg"} className="group-hover:bg-white! group-hover:text-blue-700! group-focus:bg-white! group-focus:text-blue-700! group-   group-   duration-150"><FaPhoneAlt /></Center>
                        ...
                        <GridItem>
                            <Flex asChild _hover={{ bg: "blue.700", color: "bg" }} _focus={{ bg: "blue.700", color: "bg" }} tabIndex={0}   className="duration-150 group" gap={4} alignItems={"center"} p={6} bg={"bg"} rounded={"lg"} shadow={"3px 3px 0 0 var(--chakra-colors-blue-600), -3px -3px 0 0 var(--chakra-colors-blue-400)"} px={8} h={"full"}>
                                ...
                                <Center w={14} fontSize={"2xl"} aspectRatio={"square"} bg={"blue.700"} rounded={"full"} tabIndex={0} color={"bg"} className="group-hover:bg-white! group-hover:text-blue-700! group-focus:bg-white! group-focus:text-blue-700! group-   group-   duration-150"><FaLocationDot /></Center>
