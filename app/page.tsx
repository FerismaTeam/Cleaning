        ...
        <Box as={"section"} id="services">
            ...
            <Box pos="relative">
                ...
                <VStack rounded={"md"} className="gradient_dark_background" color={"bg"} gap={5} py={10} px={6} align={"center"}>
                    ...
                    <Text textAlign={"center"} fontSize={"sm"}>Nutzen Sie unsere Kombi-Angebote für Büroreinigung und Fahrzeugaufbereitung. Ideal für Unternehmen mit Firmenfahrzeugen.</Text>
