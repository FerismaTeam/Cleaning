                ...
                <Box  w={{ base: "full", lg: "50%" }}>
                    <VStack gap={2} align={"start"} w={"fit"} mx={"auto"}>
                        ...
                        <HStack gap={2} mt={5} flexWrap={"wrap"}>
                            ...
                            <Button asChild colorPalette={"blue"} _hover={{ bg: "blue.700" }} _active={{ bg: "blue.700" }} rounded={"lg"}>
                                <Link href={"/#contact"}>
        ...
        <Box as={"section"} id="services">
            ...
            <Box pos="relative">
                ...
                >
                    ...
                    <GridItem tabIndex={0} _active={{ bg: "green.100/50" }} _hover={{ bg: "green.100/50" }} shadow={"sm"} rounded={"sm"} bg={"bg"} p={{ base: 3, sm: 5 }}>
                    ...
                    <GridItem _hover={{ bg: "blue.100/50" }} tabIndex={0}  _active={{ bg: "blue.100/50" }} shadow={"sm"} rounded={"sm"} bg={"bg"} p={{ base: 3, sm: 5 }}>
                        ...
                        <VStack align={"start"} gap={5}>
                            ...
                            <Button asChild colorPalette={"blue"} _hover={{ bg: "blue.700" }} _active={{ bg: "blue.700" }} w="full" shadow={"md"}>
                ...
                <VStack rounded={"md"} className="gradient_dark_background" color={"bg"} gap={5} py={10} px={6} align={"center"}>
                    ...
                    <Button asChild bg={"bg"} color={"blue.800"} _hover={{ bg: "blue.600", color: "bg" }} _active={{ bg: "blue.600", color: "bg" }} shadow={"md"}>
                        <Link href={"/#contact"}>
        ...
        <Box as={"section"} className="gradient_dark_background" color={"bg"}>
            <Box py={6} w={"full"}>
                <VStack textAlign={"center"} gap={10} w="100%">
                    ...
                    <Button asChild bg={"bg/15"} border={"2px solid"} borderColor={"bg/40"} _hover={{ bg: "blue.600", color: "bg" }} _active={{ bg: "blue.600", color: "bg" }} shadow={"md"}>
                        <Link href={"/ueber-uns"}>
                    ...
                    >
                        <GridItem _hover={{ bg: "bg/25" }} tabIndex={0} _active={{ bg: "bg/25" }} w={"full"} h={"full"} bg={"bg/15"} border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={5}>
...
erfolgreich abgeschlossen</Text>
                    ...
                    >
                        <GridItem textAlign={"left"} _hover={{ bg: "bg/25" }} tabIndex={0} _active={{ bg: "bg/25" }} w={"full"} h={"full"} bg={"bg/15"} border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={5}>
                    ...
                    {/* {
                        ...
                        >
                            {
                                reviews.map((item, i) => {
                                    return <GridItem key={i} textAlign={"left"} _hover={{ bg: "bg/25" }} tabIndex={0} _active={{ bg: "bg/25" }} w={"full"} h={"full"} bg={"bg/15"} border={"1px solid"} borderColor={"bg/40"} rounded={"xl"} shadow={"xl"} p={5}>
                                    <VStack align={"start"} gap={3}>
                        ...
                        services.map((service, i) => {
                            return <GridItem asChild key={i}>
                                <Link href={`/${service.link}`}>
                                    ...
                                    <VStack _hover={{ bg: "blue.800", color: "bg" }} tabIndex={0} _active={{ bg: "blue.800", color: "bg" }} className="duration-150 group" bg={"bg"} rounded={"lg"} shadow={"md"} gap={3} align={"start"} h="full" p={5}>

                                        <Center w={10} tabIndex={0} aspectRatio={"square"} className="group-hover:bg-white! group-hover:text-blue-800! group-active:bg-white! group-active:text-blue-800!" rounded={"md"} bg={"blue.700"} color={"bg"} fontSize={"xl"}>
                                            <service.icon />
                                        </Center>
                                        ...
                                        <List.Root gap={2} variant="plain" align="center" className="group-hover:text-white! group-active:text-white!" tabIndex={0} color={"bg.inverted/80"}>
                                    
                                            {
                                                service.features.map((feature, i) => {
                                                    return <List.Item key={i}>
                                                                <List.Indicator asChild color="green.500" className="group-hover:text-white! group-active:text-white!" tabIndex={0} scale={0.8}>
                                                                    <FaCheck />
                                                                </List.Indicator>
                                                            <Text fontSize={"sm"}>  
                                                                {feature}
                ...
                <Box  w={{ base: "full", lg: "50%" }}>
                    <VStack gap={2} align={"start"} w={"fit"} mx={"auto"}>
                        ...
                        <HStack gap={2} mt={5} flexWrap={"wrap"}>
                            ...
                            <Button asChild colorPalette={"blue"} _hover={{ bg: "blue.700" }} _active={{ bg: "blue.700" }} className="p-2! h-9!" rounded={"lg"}>
                                <Link href={"/uber-uns"}>
                            ...
                            <Button asChild color={"blue.600"} _hover={{ bg: "bg.muted/80" }} _active={{ bg: "bg.muted/80" }} bg={"bg"} border={"1px solid"} borderColor={"blue.600"} className="p-2! h-9!" rounded={"lg"}>
                                <Link href={`/#contact`}>
            ...
            <VStack>
                ...
                <Box asChild w={"full"} p={{ base: 3, md: 5 }} rounded={"md"} bg={"bg"}>
                    <form onSubmit={handleContact} ref={formRef}>
                        ...
                        <Button type="submit" colorPalette={"blue"} _hover={{ bg: "blue.700" }} _active={{ bg: "blue.700" }} w="full" rounded={"lg"}>
