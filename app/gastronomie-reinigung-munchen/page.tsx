...
const RestaurantCleaningServicePage = () => {
    ...
    return (
        ...
        <Box as={"section"}>
            ...
            <VStack w={"full"}>
                <Badge mb={3} shadow={"lg"} color={"bg"} bg={"blue.600"} rounded={"full"} px={3} py={1} size={"lg"}><Text as={"span"} scale={0.9} mr={0.5}><FaInfoCircle /></Text>    ÜBER UNSERE GASTRONOMIE-REINIGUNG</Badge>
